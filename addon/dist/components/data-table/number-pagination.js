...
var _class, _NumberPaginationComponent;
...
/* Used in: data-table.hbs */ /**
                              ...
                              */
let NumberPaginationComponent = (_class = (_NumberPaginationComponent = class NumberPaginationComponent extends Component {
  ...
  */
  ...
  get startIndex() {
    ...
    if (this.args.itemsOnCurrentPage == 0 && this.isFirstPage)
      ...
      return 0;else return zeroToHumanBased(this.args.size * humanToZeroBased(this.humanPage));
  }
  get endIndex() {
    ...
    if (this.args.itemsOnCurrentPage == 0 && this.isFirstPage)
      // human probably expects to see 0-0 when no items exist.
      return 0;else return this.startIndex - 1 + this.args.itemsOnCurrentPage;
  }
  get numberOfPages() {
  ...
  */
  get pageOptions() {
    return Array.from(new Array(this.numberOfPages), (_val, index) => this.firstPage + index);
  }
  /**
  ...
  */
  get summarizedPageOptions() {
    ...
    if (this.numberOfPages > 0) {
      if (this.isFirstPage || this.isLastPage) {
        ...
        const currentPageWindow = [x - 2, x - 1, x, x + 1, x + 2].filter(i => i >= this.firstPage && i <= this.lastPage);
        let prepend = [];
        let append = [];
  ...
  get total() {
    if (this.args.total !== undefined) return this.args.total;else if (this.args.meta?.count !== undefined) return this.args.meta.count;else return undefined;
  }
  get hasTotal() {
  ...
  `, {
  component: _NumberPaginationComponent,
  eval() {
    return eval(arguments[0]);
  }
}), _NumberPaginationComponent), _applyDecoratedDescriptor(_class.prototype, "updateHumanPage", [action], Object.getOwnPropertyDescriptor(_class.prototype, "updateHumanPage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "updatePage", [action], Object.getOwnPropertyDescriptor(_class.prototype, "updatePage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "selectSizeOption", [action], Object.getOwnPropertyDescriptor(_class.prototype, "selectSizeOption"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setSizeOption", [action], Object.getOwnPropertyDescriptor(_class.prototype, "setSizeOption"), _class.prototype), _class);

export { NumberPaginationComponent as default };
