 ...
 */
function definitionsToArray(stringOrArray) {
 ...
 */
function toComponentSpecifications(spaceSeparatedSpecifications, configuration) {
  return definitionsToArray(spaceSeparatedSpecifications).map(specification => toComponentSpecification(specification, configuration));
}

/**
 * see toComponentSpecifications. This also handles objects with already unpacked specifications.
 */
function toComponentSpecification(specification, configuration) {
  let obj = {};
...
export { deUnderscoreString, definitionsToArray, splitDefinitions, toComponentSpecification, toComponentSpecifications };
//# sourceMappingURL=string-specification-helpers.js.map
